...
public class AttachFileDTO {
	...
	public File findThumnailFile(String uploadDir) {
		return new File(uploadDir + File.separator + pathName + File.separator + THUMBNAIL_FILE_PREFIX + uuid + THUMBNAIL_FILE_POSTFIX);
	}
	
	public File findUploadedFile(String uploadDir) {
		return new File(uploadDir + File.separator + pathName + File.separator + uuid + '_' + originalFilePureName);
	}
