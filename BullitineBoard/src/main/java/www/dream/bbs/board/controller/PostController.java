...
public class PostController {
	...
	// /post/annonymous/listAll/000n
	@GetMapping("/annonymous/listAll/{boardId}/{page}")
	...
	@GetMapping("/annonymous/search/{boardId}/{search}/{page}")
	...
	public ResponseEntity<Integer> mngPost(@AuthenticationPrincipal PartyVO user, @RequestBody PostVO post) {
		//post.setWriter(user);
